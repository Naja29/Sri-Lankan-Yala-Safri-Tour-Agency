...
(function () {
  ...
  function injectFooter() {
    ...
    <footer id="site-footer">
      <!-- Wildlife silhouette images side by side -->
      <div class="footer-silhouette-wrap">
        <img class="footer-silhouette-img" src="${base}images/footer-animals1.png" alt="" aria-hidden="true"/>
        <img class="footer-silhouette-img" src="${base}images/footer-animals2.png" alt="" aria-hidden="true"/>
      </div>
